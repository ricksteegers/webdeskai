    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-cyan-50 relative overflow-hidden">
      ...
      <Helmet>
        ...
        {JSON.stringify({
          ...
          "@type": "AboutPage",
          "name": "Over WebDesk AI",
          "description": "Leer meer over WebDesk AI, het team van AI-experts in website ontwikkeling",
          "url": "https://webdeskai.com/over-ons",
          "mainEntity": {
            "@type": "Organization",
            "name": "WebDesk AI",
            "foundingDate": "2024",
        ...
        <section className="pt-40 pb-20 relative overflow-hidden">
          ...
          <div className="text-center mb-16">
            ...
            <h1 className="text-5xl lg:text-7xl font-bold text-gray-900 mb-8 leading-tight">
              Wij zijn <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-cyan-500 animate-pulse">WebDesk AI</span>
            </h1>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div>
                <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-8">
                  Onze <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-cyan-500">Missie</span>
                </h2>
                <div className="space-y-6 text-lg text-gray-700">
                  ...
                  <p>
                    Onze missie is simpel: <strong className="text-blue-500">democratiseren van hoogwaardige webdesign</strong> 
        ...
        <section className="py-20 relative overflow-hidden">
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-20">
              <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-8">
                Onze <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-cyan-500">Waarden</span>
              </h2>
          ...
          <div className="max-w-4xl mx-auto px-6 text-center">
            <div className="bg-gradient-to-br from-white/95 to-white/80 backdrop-blur-xl rounded-3xl p-12 shadow-2xl border border-white/30 relative overflow-hidden">
              <div className="absolute inset-0 opacity-10">
                <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-blue-500 to-cyan-500 rounded-3xl transform rotate-1"></div>
              </div>
              ...
              <div className="relative z-10">
                <div className="flex items-center justify-center mb-6">
                  ...
                  <h3 className="text-3xl lg:text-4xl font-bold text-gray-900">
                    Klaar om <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-cyan-500">samen te werken</span>?
                  </h3>
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6">
                  <Link 
                    to="/contact"
                    className="group bg-transparent border-2 border-blue-500 text-gray-800 px-10 py-5 rounded-full font-semibold text-lg hover:bg-blue-500 hover:text-white transition-all duration-500 shadow-lg hover:shadow-2xl transform hover:-translate-y-3 hover:scale-110 backdrop-blur-sm relative overflow-hidden"
                  >
                  ...
                  <div className="flex items-center space-x-4 text-gray-600">
                    ...
                    <div className="flex items-center">
                      <span className="font-semibold text-blue-500">Gratis advies</span>
                    </div>
                  </div>
                </div>
              </div>
