        ...
        <section className="pt-32 pb-20 relative overflow-hidden">
          ...
          <div className="mb-8 relative">
            <div className="w-32 h-32 bg-gradient-to-br from-green-500 to-emerald-600 rounded-full flex items-center justify-center mx-auto shadow-2xl animate-bounce-in relative overflow-hidden">
              ...
              <div className="absolute -top-4 -left-4 w-6 h-6 bg-blue-400 rounded-full animate-ping opacity-60"></div>
              <div className="absolute -top-2 -right-6 w-4 h-4 bg-cyan-400 rounded-full animate-ping opacity-40" style={{ animationDelay: '0.5s' }}></div>
          ...
          {/* CTA Section */}
          <div className="bg-gradient-to-br from-blue-500/10 to-cyan-500/10 rounded-3xl p-8 border border-blue-500/20 animate-fade-in-up" style={{ animationDelay: '1.2s' }}>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6">
              <Link 
                to="/"
                className="group bg-transparent border-2 border-blue-500 text-gray-800 px-8 py-4 rounded-full font-semibold hover:bg-blue-500 hover:text-white transition-all duration-500 shadow-lg hover:shadow-xl transform hover:-translate-y-2 flex items-center"
              >
                Terug naar homepage
